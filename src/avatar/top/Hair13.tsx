  ...
  render () {
    ...
    return (
      <g id='Top' strokeWidth='1' fillRule='evenodd'>
        ...
        <g id='Mask' />
        <g id='Top/Long-Hair/Hair13' mask={`url(#${mask1})`}>
