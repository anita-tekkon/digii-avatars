...
var CustomTest = /** @class */ (function (_super) {
    ...
    CustomTest.prototype.render = function () {
        ...
        return (React.createElement("g", { id: 'Custom/Custom-Test', transform: 'translate(188.000000, 48.000000)' },
            ...
            React.createElement("use", { id: 'Custom', fill: '#252E32', fillRule: 'evenodd', xlinkHref: '#' + path1 }),
            React.createElement("use", { id: 'Custom', fill: '#252E32', fillRule: 'evenodd', xlinkHref: '#' + path2 }),
            React.createElement("use", { id: 'Custom', fill: '#252E32', fillRule: 'evenodd', xlinkHref: '#' + path3 }),
            React.createElement("use", { id: 'Custom', fill: '#252E32', fillRule: 'evenodd', xlinkHref: '#' + path4 }),
            React.createElement("use", { id: 'Custom', fill: '#252E32', fillRule: 'evenodd', xlinkHref: '#' + path5 }),
            React.createElement("use", { id: 'Custom', fill: '#252E32', fillRule: 'evenodd', xlinkHref: '#' + path6 }),
            React.createElement("use", { id: 'Custom', fill: '#252E32', fillRule: 'evenodd', xlinkHref: '#' + path7 }),
