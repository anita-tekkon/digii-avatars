...
function makeColor(name, color) {
    var ColorComponent = /** @class */ (function (_super) {
        ...
        ColorComponent.prototype.render = function () {
            return (React.createElement("g", { id: 'Color/CustomAccessory/Brown', mask: "url(#".concat(this.props.maskID, ")"), fill: color },
...
var Colors = /** @class */ (function (_super) {
    ...
    Colors.prototype.render = function () {
        return (React.createElement(options_1.Selector, { option: options_1.CustomAccessoryColor, defaultOption: BrownDark },
